...
public class PlayerItemInfo {
	...
	public boolean owns(String item) {
		ConfigSection itemSection = data.getChild("inv." + type);
	...
	public void bought(String item) {
		ConfigSection itemSection = data.getChild("inv." + type, true);
	...
	public boolean isSelected(String item) {
		ConfigSection selectedSection = data.getChild("inv." + type + ".selected");
	...
	public void increaseAmount(String item) {
		ConfigSection selectedSection = data.getChild("inv." + type + ".selected", true);
	...
	public void saveSelectedConfiguration(ItemStack[] itemStacks) {
		System.out.println(Arrays.asList(itemStacks));
		String key = "inv." + type + ".selected";
		data.remove(key);
