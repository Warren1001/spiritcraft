package com.kabryxis.spiritcraft.game.a.game.object;
...
public class GameObjectManager<T extends GameObject> {
	...
	private final Map<String, Function<GameObjectManager<T>, T>> gameObjectCreators = new HashMap<>();
	private final Map<T, CommandHandler> commandHandlerMap = new HashMap<>();
	...
	public GameObjectManager(Game game, Class<T> clazz) {
		this.game = game;
	...
	public void registerCreator(String name, Function<GameObjectManager<T>, T> creator) {
	...
	public CommandHandler getCommandHandler(T object) {
