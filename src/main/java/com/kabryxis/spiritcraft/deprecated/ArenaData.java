...
public class ArenaData {
	...
	private SpiritDimData spiritDimData;
	...
	public void teleportToOtherDim(Entity entity) {
		...
		else throw new IllegalStateException(entity.getName() + " could not be found in a game world when trying to teleport between worlds.");
		Runnable run = () -> {
			entity.teleport(loc);
